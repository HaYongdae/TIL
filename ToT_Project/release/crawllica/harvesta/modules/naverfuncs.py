...
#     #결과 반환 (없으면 없는대로)
#     return resultList
def get_newslist(search_words, cnt, sdate, edate):
    ...
    surl = "&sm=tab_pge&sort=0&photo=0&field=0&reporter_article=&pd=3&ds="+sdate[0:4]+"."+sdate[4:6]+"."+sdate[6:8]+"&de="+edate[0:4]+"."+edate[4:6]+"."+edate[6:8]
    lurl = "&docid=&nso=so:r,p:from"+sdate+"to"+edate+",a:all&mynews=0&refresh_start=0&start="
    # print(lurl)
