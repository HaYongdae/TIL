...
##################단일 집단 비율 검정 실습###################
data <- read.csv("C:/Users/student/Desktop/datafile-II/data-3/Part-3/one_sample.csv", header=TRUE)
head(data)
str(data)   
View(data)
...
##############두 집단 비율 차이 검정 실습 ######################
data <- read.csv("C:/Users/student/Desktop/datafile-II/data-3/Part-3/two_sample.csv", header=TRUE)
(data)
...
data <- read.csv("C:/Users/student/Desktop/datafile-II/data-3/Part-3/paired_sample.csv", header=TRUE)
head(data)
...
#################세 집단  만족도  차이 비율 검정######################
data <- read.csv("C:/Users/student/Desktop/datafile-II/data-3/Part-3/three_sample.csv", header=TRUE)
head(data)
