dau <- read.csv("C:/Users/student/Desktop/workshop3_data/workshop2_data/ws3-dau.csv")
user.info <- read.csv("C:/Users/student/Desktop/workshop3_data/workshop2_data/ws3-user_info.csv")
